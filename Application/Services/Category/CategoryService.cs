...
public class CategoryService : ICategoryService
{
    ...
    {
        Func<IQueryable<Domain.Entities.Category>, IOrderedQueryable<Domain.Entities.Category>>? orderBy =
            paginationDto.Descending
    ...
    {
        var category = await _unitOfWork.GetRepository<Domain.Entities.Category>()
    ...
    {
        var fromDb = await _unitOfWork.GetRepository<Domain.Entities.Category>()
                         .GetByIdAsync(categoryDto.Id, cancellationToken)
