    ...
    public RegistrationRequestValidator(IOptions<AuthOptions> options)
    {
        ...
        RuleFor(x => x.FirstName)
            ...
            .MinimumLength(validation.NameMinLength)
                .WithMessage($"First name must be at least {validation.NameMinLength} characters long.")
        ...
        RuleFor(x => x.LastName)
            ...
            .MinimumLength(validation.NameMinLength)
                .WithMessage($"Last name must be at least {validation.NameMinLength} characters long.")
            .MaximumLength(validation.NameMaxLength)
